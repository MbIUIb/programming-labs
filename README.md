...
Написать программу, окно логин пароль регистрация. Соответственно можно зарегистрироваться, можно войти. Данные зарегистриванных пользователей хранится в БД.
Пароль не храним в открытом ввиде, а храним его хэш.